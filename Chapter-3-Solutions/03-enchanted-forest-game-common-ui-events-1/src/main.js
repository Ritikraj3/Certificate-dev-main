...
const magicPortalForm = document.getElementById("magicPortalForm");
magicPortalForm.addEventListener("keydown", (e) => {
  if (e.key === "Enter") {
    e.preventDefault();
...
const fairy = document.getElementsByClassName("fairy");
fairy.addEventListener("mousemove", (e) => {
  if (e.ctrlKey) {
...
// 4. Summon Fireflies
const fireflyButton = document.getElementById('fireflyButton')
